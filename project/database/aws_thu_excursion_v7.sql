...
--
-- Host: aws-in1-thuexcursion.cn1txtym6kn9.us-east-2.rds.amazonaws.com    Database: thu_excursion
-- ------------------------------------------------------
...
CREATE TABLE `excursion` (
  ...
  `approval_status` enum('p','a','d') NOT NULL DEFAULT 'p',
...
INSERT INTO `excursion` VALUES (12,'Neuschwanstein Castle and Linderhof Palace Day Tour from Munich','2020-12-31 23:00:00',25,'2021-01-15','2021-01-30','Ulm HBF','Neuschwanstein Castle and Linderhof Palace',1,'2021-02-02','Munich',60,1,NULL,0,''),(13,'Exclusive and Unique Romantic Road Tour from Munich to Rothenberg','2021-07-31 22:00:00',25,'2021-08-14','2021-08-29','Ulm HBF','Romantic Road in Rothenberg',1,'2021-09-03','Rothenberg',25,1,NULL,0,''),(14,'Private Scenic Transfer from Frankfurt to Munich with 4h of Sightseeing','2021-10-31 23:00:00',25,'2021-11-15','2021-11-27','Ulm HBF','Sightseeing in Munich',1,'2021-12-06','Munich',50,0,NULL,0,''),(18,'Dachau Concentration Camp Memorial Site Tour from Munich by Train','2021-12-31 23:00:00',25,'2022-01-15','2022-01-31','Ulm HBF','Concentration Camp',1,'2022-02-08','Munich',90,0,NULL,0,''),(19,'Heidelberg Half-Day Trip from Frankfurt','2022-01-31 23:00:00',25,'2022-02-01','2022-02-15','Ulm HBF','Heidelberg Half-day Trip',1,'2022-02-18','Heidelberg',35,0,NULL,0,''),(20,'Private Rhine Valley Day Trip from Frankfurt With Wine Tasting','2022-03-02 23:00:00',25,'2022-03-15','2022-03-25','Ulm HBF','Rhine Valley Day Trip',1,'2022-03-28','Frankfurt',32,0,NULL,0,''),(21,'Berlin Complete History All Day Tour','2023-06-01 22:00:00',25,'2023-06-17','2023-06-27','Ulm HBF','Berlin History Tour',1,'2023-06-29','Berlin',25,0,NULL,0,''),(22,'Sachsenhausen Concentration Camp Memorial Tour from Berlin','2023-07-31 22:00:00',25,'2023-08-15','2023-08-29','Ulm HBF','Sachsenhausen Camp',1,'2023-09-02','Berlin',36,0,NULL,0,''),(23,'City Tour Cologne','2023-08-31 22:00:00',25,'2023-09-15','2023-09-25','Ulm HBF','City Tour in Cologne',1,'2023-09-26','Cologne',65,0,NULL,0,''),(24,'Day Trip from Munich to Salzburg','2023-09-30 22:00:00',25,'2023-10-15','2023-10-21','Ulm Hbf','Day Trip Salzburg',1,'2023-10-25','Salzburg',20,0,NULL,0,''),(25,'Pompeu University Spain','2021-12-01 20:12:04',25,'2021-08-15','2021-08-30','Ulm HBF','Spain Day-Trip',1,'2021-09-04','Spain Barcelona',60,0,NULL,0,''),(26,'UP Manila','2021-12-01 22:18:22',25,'2021-08-15','2021-08-30','Ulm HBF','UP Manila',1,'2021-09-04','Spain Barcelona',60,0,NULL,0,''),(27,'Pompeu University Spain','2021-12-02 11:28:38',25,'2021-08-15','2021-08-30','Ulm HBF','Spain Day-Trip',1,'2021-09-04','Spain Barcelona',60,0,'2021-08-02',0,''),(28,'Giethoorn Netherlands','2021-12-03 16:00:04',25,'2021-08-14','2021-08-29','Ulm HBF','Village with no roads',1,'2021-09-03','Netherlands',60,0,'2021-08-01',0,''),(29,'Head along the enchanting road through bohemian Europe','2021-12-03 16:16:56',25,'2021-08-14','2021-08-29','Ulm HBF','Education Trip in Venice Italy',1,'2021-09-03','Italy',60,0,'2021-08-01',0,'');
/*!40000 ALTER TABLE `excursion` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Temporary view structure for view `max_participants_verification`
--

DROP TABLE IF EXISTS `max_participants_verification`;
/*!50001 DROP VIEW IF EXISTS `max_participants_verification`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `max_participants_verification` AS SELECT 
 1 AS `id_excursion`,
 1 AS `bookings`,
 1 AS `max_participants`,
 1 AS `places_available`,
 1 AS `is_booking_allowed`*/;
...
--
-- Final view structure for view `max_participants_verification`
--
...
/*!50001 VIEW `max_participants_verification` AS select `rs2`.`id_excursion` AS `id_excursion`,`rs2`.`bookings` AS `bookings`,`rs2`.`max_participants` AS `max_participants`,`rs2`.`places_available` AS `places_available`,(case when (`rs2`.`places_available` > 0) then true when (`rs2`.`places_available` = 0) then false else false end) AS `is_booking_allowed` from (select `rs1`.`id_excursion` AS `id_excursion`,`rs1`.`bookings` AS `bookings`,`rs1`.`max_participants` AS `max_participants`,(`rs1`.`max_participants` - `rs1`.`bookings`) AS `places_available` from (select `student_booking_excursion`.`id_excursion` AS `id_excursion`,count(`student_booking_excursion`.`booked_by`) AS `bookings`,`student_booking_excursion`.`max_participants` AS `max_participants` from `student_booking_excursion` group by `student_booking_excursion`.`id_excursion`) `rs1`) `rs2` */;
...
-- Dump completed on 2021-12-28 20:23:27
